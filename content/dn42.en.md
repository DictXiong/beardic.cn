...
- ASN: 4242421366
- Maintainer: [Dict Xiong](mailto:me@dxng.cn)
- IPv4 range: `172.21.123.64/26`
- IPv6 range: `fda5:adba:5953::/48`
- // Domain: `bd.dn42`
	- // Name Server: ns1.bd.dn42 (`172.21.123.65`)
- Border nodes: (Note that `dxng.net` was formerly `ibd.ink`. Please update if you are still using `ibd.ink` domains for tunnel endpoint)

| Node | Clearnet Name | DN42 Name      | DN42 Address                    | WireGuard Pubkey | Preference |
| ---- | ------------- | -------------- | ------------------------------- | --- | --- |
| hk1  | hk1.dxng.net   | hk1.i.bd.dn42  | `172.21.123.65`/`fda5:adba:5953::1` | `Pa0DXsaKihcwHdyJkFpYjHjATIznZBBcnlilRPa3+A0=` | +++ |
| sir0 | sir0.dxng.net  | sir0.i.bd.dn42 | `172.21.123.66`/`fda5:adba:5953::2` | `l3ptCaaJlKvRJfKP04Lrcrwe0OCdcuERWRSPP/+0M1s=` | ++++ |
| pi1  | pi1.dxng.net   | pi1.i.bd.dn42  | `172.21.123.68`/`fda5:adba:5953::4` | `W9HDl869HCdG8ci9jH5AawiCZAAi1xFAvBTzT0MEJUg=` | ++ |
| cn1  | cn1.dxng.net   | cn1.i.bd.dn42  | `172.21.123.69`/`fda5:adba:5953::5` | `SvkQTkqFdtzNnFYCRMQuUMTCErMmdd/ZBgZ+T39X0D8=` | - |
| hk0  | hk0.dxng.net   | hk0.i.bd.dn42  | `172.21.123.70`/`fda5:adba:5953::6` | `EoPA+dH5xxHwUYCVpe/3afL0qQp5SQB7b2OHD8nrB30=` | +++++ |
...
- Contact us via [Email](mailto:me@dxng.cn) or [Telegram](https://t.me/DictXiong).
